        ...
        <div style={{
            ...
            <div style={{ backgroundColor: "rgb(25, 39, 52)", padding: "1px 10px", margin: "15px", }}>
                <div style={{ marginLeft: "30px", paddingTop: "5px", color: "rgb(136, 153, 166)", }}>
                    ユーザ名</div>
                <input class="text-area" type="text" style={{ width: "550px", display: "block", margin: "0 auto", height: "25px", backgroundColor: "rgba(0, 0, 0, 0)", border: "1px solid rgba(0, 0, 0, 0)", borderBottom: "3px solid rgb(136, 153, 166)", }} />
            ...
            <div style={{ marginBottom: "20px", }}>
                <a class="a-to-block2 btn--orange" href="" style={{ borderRadius: "30px", height: "50px", textAlign: "center", width: "550px", margin: "0 auto", }}>
